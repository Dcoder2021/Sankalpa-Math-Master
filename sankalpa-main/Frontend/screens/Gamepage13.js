...
const GamePage13 = ({ navigation, route }) => {
    const { G1 } = route.params;
                    ...
                    <View style={styles.box2}>
                        ...
                        <View style={styles.box3}>
                            ...
                            <View style={styles.boxb}>
                                <Text style={styles.largeText} variant="displayLarge">45 + 50 = 85</Text>
