...
const GamePage11 = ({ navigation, route }) => {
    ...
    const handlePress = async (selectedOption) => {
        ...
        const percentageOfTrueValues = (trueValuesCount / totalPropertiesCount) * 100; //calculate full mark
        ...
        try {
            ...
            if (currentStudentID) {
                ...
                const updateApiUrl = `http://192.168.1.100:8000/api/student/update/${currentStudentID}`;
                ...
                try {
                    ...
                    const probabilityApiUrl = 'http://192.168.1.100:5000/probability';
    ...
    useEffect(() => {
        ...
        const timeout = setTimeout(() => {
            if (!buttonPressed) {
                ...
                navigation.navigate('QuizResult'); // Replace with your screen name
            }
        }, 30000); // 30 seconds
