...
const GamePage15 = ({ navigation, route }) => {
    const { G3 } = route.params;
                    ...
                    <View style={styles.box2}>
                        ...
                        <View style={styles.box3}>
                            ...
                            <View style={styles.boxb}>
                                <Text style={styles.largeText} variant="displayLarge">109 x 5 = 454</Text>
