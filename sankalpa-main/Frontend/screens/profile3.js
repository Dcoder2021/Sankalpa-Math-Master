...
const Profile3 = ({ navigation, route }) => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://192.168.1.100:8000/api/teachers');
    ...
    const Next = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.1.100:8000/api/teachersby', sentTeachername);
            ...
            if (response.data && response.data.length > 0) {
                ...
                try {
                    ...
                    if (studentID) {
                        const apiUrl = `http://192.168.1.100:8000/api/student/update/${studentID}`;
